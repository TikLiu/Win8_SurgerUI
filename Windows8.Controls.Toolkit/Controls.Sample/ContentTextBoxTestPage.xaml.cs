...
namespace Controls.Sample
{
    ...
    /// </summary>
    public sealed partial class ContentTextBoxTestPage : Page
    {
        public ContentTextBoxTestPage()
        {
            this.InitializeComponent();
            this.Loaded += ContentTextBoxTestPage_Loaded;
        }

        void ContentTextBoxTestPage_Loaded(object sender, RoutedEventArgs e)
        {
            mp.Items = GetTestSample();
            //contentTextBox.Focus(Windows.UI.Xaml.FocusState.Keyboard);
        }
        ...
        void contentTextBox_CancelButtonClick(object sender, RoutedEventArgs e)
        {
            //contentTextBox.IsOpen = false;
        ...
        void contentTextBox_OkButtonClick(object sender, RoutedEventArgs e)
        {
