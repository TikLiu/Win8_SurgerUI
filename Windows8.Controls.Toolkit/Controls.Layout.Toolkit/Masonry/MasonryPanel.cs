...
namespace Controls.Layout.Toolkit
{
    public sealed class MasonryPanel : Control
    {
        ...
        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register("Items", typeof(List<MasonryItem>), typeof(MasonryPanel), new PropertyMetadata(null, (s, e) =>
            {
                var panel = s as MasonryPanel;
                var items = e.NewValue as List<MasonryItem>;
        ...
        public static readonly DependencyProperty LayoutTypeProperty =
            DependencyProperty.Register("LayoutType", typeof(MasonryPanelLayoutType), typeof(MasonryPanel), new PropertyMetadata(MasonryPanelLayoutType.Auto));
        ...
        // Using a DependencyProperty as the backing store for MaxnumHeight.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MaxnumHeightProperty =
            DependencyProperty.Register("MaxnumHeight", typeof(double), typeof(MasonryPanel), new PropertyMetadata(900));
        ...
        // Using a DependencyProperty as the backing store for ElementInterval.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ElementIntervalProperty =
            DependencyProperty.Register("ElementInterval", typeof(double), typeof(MasonryPanel), new PropertyMetadata(0.0));
        ...
        public static readonly DependencyProperty LargeImageNumberProperty =
            DependencyProperty.Register("LargeImageNumber", typeof(int), typeof(MasonryPanel), new PropertyMetadata(1));
        ...
        // Using a DependencyProperty as the backing store for MiddleImageColumns.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MiddleImageNumberProperty =
            DependencyProperty.Register("MiddleImageNumber", typeof(int), typeof(MasonryPanel), new PropertyMetadata(2));
