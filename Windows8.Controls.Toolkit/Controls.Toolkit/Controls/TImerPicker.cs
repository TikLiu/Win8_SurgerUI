...
{
    public sealed class TimerPicker : Control
    {          
        TextBlock HourText1;
        TextBlock HourText2;
        ...
        public TimerPicker()
        {
            this.DefaultStyleKey = typeof(TimerPicker);
            Loaded += TimerPicker_Loaded;
            Unloaded += TimerPicker_Unloaded;
        }

        void TimerPicker_Unloaded(object sender, RoutedEventArgs e)
        {
        ...
        void TimerPicker_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            AMText = GetTemplateChild("AMtext") as TextBlock;
            PMText = GetTemplateChild("PMtext") as TextBlock;
            setTime();
        }
    }
}
